# Primera parte del código (líneas 1-2000)
# Contiene imports, configuraciones, estilos CSS, parámetros iniciales y funciones básicas
...
# Segunda parte del código (continuación)
# Contiene funciones principales de análisis, cálculo de NPK, rendimiento y funciones económicas
